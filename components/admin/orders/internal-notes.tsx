  ...
  return (
    <div className="rounded-2xl border border-stone-200 bg-white p-5">
      ...
      <textarea
        ...
        rows={4}
        className="w-full rounded-md border border-stone-200 bg-stone-50/50 px-3 py-2 text-sm focus:outline-none focus:border-(--color-brand-yellow) focus:bg-white focus:ring-2 focus:ring-(--color-brand-yellow-bright)/30"
      />
