              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    active
                      ? 'bg-[--color-accent]/15 text-white font-medium'
                ...
                >
                  {active && (
                    <span
                      aria-hidden
                      className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-0.5 bg-[--color-accent-bright] rounded-r-full"
                    />
                  )}
                  <Icon
                    className={cn(
                      'h-4 w-4 shrink-0',
                      active ? 'text-[--color-accent-bright]' : 'text-white/50 group-hover:text-white/70',
                    )}
                  />
      ...
      <div className="border-t border-white/5 p-3 shrink-0">
        <div className="px-2 py-2">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-full bg-[--color-accent]/20 text-[--color-accent-bright] inline-flex items-center justify-center font-semibold text-sm">
