                ...
                {(['meal', 'package', 'tryout'] as const).map((t) => (
                  <label
                    ...
                    className={cn(
                      ...
                      state.type === t ? 'border-(--color-brand-yellow) bg-(--color-brand-yellow-bright)/10 text-(--color-brand-yellow) font-medium' : 'border-stone-200 bg-white hover:bg-stone-50',
                    )}
                  >
                    <input
                      type="radio"
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        checked
                          ? 'border-(--color-brand-yellow) bg-(--color-brand-yellow-bright)/15 text-(--color-brand-yellow)'
...
function Input({
  ...
  return (
    <input
      ...
      className={cn(
        'h-10 w-full px-3 rounded-md border border-stone-200 bg-white text-sm focus:outline-none focus:border-(--color-brand-yellow) focus:ring-2 focus:ring-(--color-brand-yellow-bright)/30',
...
function Textarea({
  ...
  return (
    <textarea
      ...
      onChange={(e) => onChange(e.target.value)}
      rows={rows}
      className="w-full px-3 py-2 rounded-md border border-stone-200 bg-white text-sm focus:outline-none focus:border-(--color-brand-yellow) focus:ring-2 focus:ring-(--color-brand-yellow-bright)/30"
    />
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? `${className} ring-2 ring-offset-1 ring-(--color-brand-yellow)` : 'bg-white text-stone-500 border-stone-200 hover:border-stone-300',
      )}
    >
      {label}
    </button>
