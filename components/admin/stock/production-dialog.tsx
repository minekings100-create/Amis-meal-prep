  ...
  return (
    <Dialog.Root open={open} onOpenChange={(v) => { setOpen(v); if (!v) reset(); }}>
      <Dialog.Trigger asChild>
        <button className="inline-flex items-center gap-2 h-10 px-4 rounded-md bg-(--color-brand-black) text-white text-sm font-medium hover:bg-stone-800">
          ...
          <div className="flex items-center justify-between gap-4 px-6 py-4 border-t border-stone-200 bg-stone-50/50">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 h-10 px-5 rounded-md bg-(--color-brand-black) text-white font-semibold text-sm hover:bg-stone-800 disabled:opacity-50 disabled:cursor-not-allowed"
              >
