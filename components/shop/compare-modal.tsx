        ...
        <>
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="inline-flex items-center gap-1 h-8 px-3 rounded-full bg-(--color-brand-yellow-bright) text-stone-900 text-xs font-semibold hover:bg-(--color-brand-yellow) hover:text-(--color-brand-black) transition-colors"
            >
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isWinner ? 'text-(--color-brand-yellow) font-semibold' : 'text-stone-800',
                  )}
                >
                  {isWinner && (
                    <Star
                      className="h-3.5 w-3.5 fill-(--color-brand-yellow-bright) text-(--color-brand-yellow-bright)"
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isWinner ? 'bg-(--color-brand-yellow-bright)/10' : 'bg-white',
                    )}
                  >
                    <div
                      className={cn(
                        'inline-flex items-center justify-center gap-1 font-mono text-sm font-semibold tabular-nums',
                        isWinner ? 'text-(--color-brand-yellow)' : 'text-stone-800',
                      )}
                    >
                      {isWinner && (
                        <Star className="h-3 w-3 fill-(--color-brand-yellow-bright) text-(--color-brand-yellow-bright)" />
                      )}
                      <span>{formatValue(v, row)}</span>
                    </div>
                  </div>
        ...
        >
          {items.map((it) => (
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 h-10 px-3 rounded-full bg-(--color-brand-yellow-bright) text-stone-900 text-xs font-semibold hover:bg-(--color-brand-yellow) hover:text-(--color-brand-black) transition-colors"
            >
