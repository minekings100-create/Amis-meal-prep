  ...
  return (
    <footer className="border-t border-stone-200/60 bg-white/60 backdrop-blur-md px-5 pt-4 pb-4 space-y-3">
      ...
      <Link
        href="/checkout"
        onClick={onClose}
        className="w-full inline-flex items-center justify-center gap-2 h-12 rounded-2xl bg-(--color-brand-black) text-white font-semibold text-sm hover:bg-(--color-brand-yellow) hover:text-(--color-brand-black) active:scale-[0.99] transition-all shadow-[0_8px_24px_-8px_rgba(10,10,10,0.35)]"
      >
        {checkoutLabel}
  ...
  return (
    <div className="px-6 py-12 text-center flex flex-col items-center">
      ...
      <Link
        href="/shop"
        onClick={onClose}
        className="mt-6 inline-flex items-center gap-1.5 h-11 px-6 rounded-2xl bg-(--color-brand-black) text-white font-semibold text-sm hover:bg-(--color-brand-yellow) hover:text-(--color-brand-black) active:scale-[0.99] transition-all"
      >
        {cta}
