...
const buttonVariants = cva(
  ...
  ].join(' '),
  {
    variants: {
      variant: {
        primary:
          'bg-(--color-brand-yellow-bright) text-(--color-ink) hover:bg-(--color-brand-yellow) hover:text-(--color-brand-black) shadow-[var(--shadow-glow)]',
        secondary:
        ...
        link: 'text-(--color-brand-yellow) underline-offset-4 hover:underline',
      },
      size: {
