      ...
      <Card title="Persoonlijke gegevens">
        ...
        <div className="mt-5 pt-4 border-t border-stone-100 flex items-center justify-between">
          ...
          <button
            ...
            onClick={save}
            disabled={pending}
            className="inline-flex items-center gap-1.5 h-10 px-5 rounded-xl bg-(--color-brand-black) text-white font-semibold text-sm hover:bg-(--color-brand-yellow) hover:text-(--color-brand-black) disabled:opacity-60"
          >
