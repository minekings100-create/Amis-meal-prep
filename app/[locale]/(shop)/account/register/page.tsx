...
function RegisterInner() {
  ...
  return (
    <div className="relative">
      ...
      <div className="rounded-2xl bg-white border border-stone-200 p-6 md:p-7 shadow-[0_2px_24px_-12px_rgba(0,0,0,0.08)]">
        <form
          onSubmit={(e) => {
            e.preventDefault();
            submit();
        ...
        >
          ...
          <button
            type="submit"
            disabled={pending}
            className="w-full h-12 rounded-xl bg-(--color-brand-black) text-white font-semibold text-sm hover:bg-(--color-brand-yellow) hover:text-(--color-brand-black) disabled:opacity-60 inline-flex items-center justify-center gap-2 mt-4"
          >
